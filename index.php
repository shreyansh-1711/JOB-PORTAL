...
<head>
	...
	<title>DART3000 - Job Portal</title>
...
<body class="home">
	...
	<div class="container-wrapper">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
							<a href="./"><img src="images/capture.PNG" alt="Logo" /></a>
						</div>
					</div>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/back.jpg');">
				<div class="container">

					<h1>your bright future starts here now</h1>
					<p>Finding your next job or career on Super Jobs</p>
